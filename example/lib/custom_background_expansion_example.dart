...
class _CustomBackgroundExpansionExample extends State<CustomBackgroundExpansionExample> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Custom Background Colors'),
      ),
  ...
  _buildList(int outerIndex) {
    ...
    // Define different color schemes for demonstration
    Color? expandedColor;
    ...
    return DragAndDropListExpansion(
      ...
      subtitle: Text('Custom Background Colors'),
